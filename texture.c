...
#include <string.h>                                           // Penser au flag -lsdl2_image
#include <SDL2/SDL.h>
...
void play_with_texture_3(SDL_Texture* my_texture,
  ...
  int nb_it = 250;                                // Nombre d'images de l'animation
...
/*********************************************************************************************************************/
  SDL_Texture* texture=load_texture_from_image("labyrinthe.gif",window, renderer );
  play_with_texture_1(texture, window,renderer) ;


 texture=load_texture_from_image("22e7.gif",window, renderer );
  play_with_texture_1(texture, window,renderer) ;

  
  
  SDL_Texture* texture3=load_texture_from_image("kora.jpg",window, renderer );
  texture=load_texture_from_image("sun.png",window, renderer );
  play_with_texture_3(texture,texture3, window,renderer) ;

  SDL_Texture* texture1=load_texture_from_image("sky.jpg",window, renderer );    //nasa-xFO2Xt33xgI-unsplash.jpg
  texture=load_texture_from_image("shadow-80x70.png",window, renderer );
  play_with_texture_5(texture1,texture, window,renderer) ;
  
 
  SDL_Texture* texture2=load_texture_from_image("space.jpg",window, renderer );
  texture=load_texture_from_image("shadow-80x70.png",window, renderer );
  play_with_texture_5(texture2,texture, window,renderer) ;

 
 
 
 
  texture=load_texture_from_image("player-spritemap-v9.png",window, renderer );
...
/******************texture sur la totalité du fenetre*************************/
    //...
