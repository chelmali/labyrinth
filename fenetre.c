...
int creationfentre()
{
    ...
    {
        window1=SDL_CreateWindow("Fenetre gauche",i,i,400,300,SDL_WINDOW_RESIZABLE);
        if(window1==NULL)
        {
        ...
        window2=SDL_CreateWindow("FENETRE DROITE",2000+i,2000+i,400,300,SDL_WINDOW_RESIZABLE);
        if(window2==NULL)
        {
